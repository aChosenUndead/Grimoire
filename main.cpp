...
int main ()
{
    ...
    Monster* Astaroth =  new Beast ( "Astaroth", 610, 120, 150,  80, 30, 'b', 1);
    Monster* Nightmare = new Beast ("Nightmare", 410, 180, 200,  70, 30, 'b', 1);
    Monster* Elysium =   new Mage  (  "Elysium", 190, 110, 150,  40, 50, 'm', 1);
    Monster* Algol =     new Mage  (    "Algol", 210, 120, 200,  50, 50, 'm', 1);
    Monster* Abyss =     new Winged(    "Abyss", 290,  90,  70, 150, 70, 'w', 1);
    Monster* Aeon =      new Winged(     "Aeon", 260,  80,  60, 140, 70, 'w', 1);
    ...
    Monster* Smough =     new Beast (    "Smough", 600, 130, 150,  80, 30, 'b', 1);
    Monster* Cinder =     new Beast (    "Cinder", 400, 190, 200,  70, 30, 'b', 1);
    Monster* Gwyndolin =  new Mage  ( "Gwyndolin", 200, 100, 150,  40, 50, 'm', 1);
    Monster* Darklurker = new Mage  ("Darklurker", 220, 110, 200,  50, 50, 'm', 1);
    Monster* Kalameet =   new Winged(  "Kalameet", 300,  80,  70, 150, 70, 'w', 1);
    Monster* Sinh =       new Winged(      "Sinh", 250,  90,  60, 140, 70, 'w', 1);
    ...
    cout << playerG->get(1)->getName() << endl << endl;
    ...
    while (playerG->getQuantity() != 0 || aiG->getQuantity() != 0){
        ...
        while (healthPlayer > 0 && healthAI > 0){
            ...
            if (hit <= accuracyPlayer){ //Calculating if the player hit
                ...
                if (typePlayer == 'm'){
                healthAI = (healthAI+spiritAI) - strengthAI;
                }
                else {
                    healthAI = (healthAI+vitalityAI) - strengthPlayer;
                }
            }
            else {
            ...
            if (hit <= accuracyAI){//Calculating if the AI hit
                ...
                if (typeAI == 'm'){
                healthPlayer = (healthPlayer+spiritPlayer) - strengthAI;
                }
                else {
                healthPlayer = (healthPlayer+vitalityPlayer) - strengthAI;
                }
            }
            else {
